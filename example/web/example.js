...
Example.main = function() {
	var input = js.Boot.__cast(js.Browser.document.getElementById("input") , HTMLInputElement);
	var button = js.Boot.__cast(js.Browser.document.getElementById("button") , HTMLButtonElement);
	var output = js.Browser.document.getElementById("output");
	button.onclick = function(e) {
		...
		root.on("value",function(snapshot,eventType) {
			var json = haxe.Json.stringify(snapshot.val());
			console.log(json);
